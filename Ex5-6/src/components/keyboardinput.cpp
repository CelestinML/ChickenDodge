...
namespace SimpleGE
{
  ...
  KeyboardInputComponent::KeyboardInputComponent(Entity& owner)
      : Component(owner), impl(std::make_unique<KeyboardInputImpl>())
  {
  }

  KeyboardInputComponent::~KeyboardInputComponent() = default;
